...
const AnalyticsGraph = () => {
  ...
  const totalUsers = mockUserData.reduce((sum, item) => sum + (item.users || 0), 0);
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="bg-white rounded-xl shadow border border-gray-100 flex-1">
          <div className="border-b px-6 py-5">
            <h3 className="text-2xl font-extrabold text-gray-800">User Growth</h3>
          </div>
              ...
              <div className="flex items-center space-x-2">
                <button
                  className={`px-3 py-1 rounded-full text-sm font-medium ${
                    timeRange === "Monthly" ? "bg-[#bfc986] text-gray-800" : "text-gray-500"
                  }`}
                ...
                <button
                  className={`px-3 py-1 rounded-full text-sm font-medium ${
                    timeRange === "Weekly" ? "bg-[#bfc986] text-gray-800" : "text-gray-500"
                  }`}
                ...
                <button
                  className={`px-3 py-1 rounded-full text-sm font-medium ${
                    timeRange === "Daily" ? "bg-[#bfc986] text-gray-800" : "text-gray-500"
                  }`}
          ...
          <div className="px-6 pb-6">
            <ResponsiveContainer width="100%" height={chartHeight}>
              <BarChart data={mockUserData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#f7faf7" />
                ...
                />
                <Bar dataKey="users" fill="#6A6D57" radius={[6, 6, 0, 0]} barSize={barSize} />
              </BarChart>
            </ResponsiveContainer>
            ...
            <div className="flex items-center justify-between mt-4 px-2">
              ...
              <div className="text-sm text-gray-700">{totalUsers.toLocaleString()} Users</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 lg:w-[36%]">
          <div className="bg-white rounded-xl shadow border border-gray-100 p-4">
            <h4 className="text-base font-semibold text-gray-700">User Activity (Last 7 Days)</h4>
