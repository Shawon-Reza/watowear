      ...
      <main className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-md font-bold">Active Users</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-md font-bold">Revenue</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-md font-bold">Subscriptions</p>
                <p className="text-3xl font-bold mt-2 text-[#6A6D57]">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={mockUserJoins}>
                ...
                <Line
                  ...
                  stroke="#6A6D57"
                  strokeWidth={3}
                  dot={{ fill: "#6A6D57", strokeWidth: 2, r: 4 }}
                  activeDot={{ r: 6, stroke: "#6A6D57", strokeWidth: 2 }}
                />
              </LineChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={mockRevenueData}>
                ...
                />
                <Bar dataKey="revenue" fill="#6A6D57" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="px-8 py-6 border-b border-gray-100">
            <h3 className="text-2xl font-bold" style={{ color: "#6A6D57" }}>
              Latest Users
            </h3>
            <p className="text-gray-500 text-sm mt-1">Recently joined users</p>
          </div>
