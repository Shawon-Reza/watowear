 ...
 */
export default function FashionHistoryManagement({ items = [], title = 'Fashion Library Management ( AI )' }) {
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full text-left text-sm">
                    ...
                    <tbody>
                        ...
                        {pageItems.length === 0 && (
                            <tr>
                                <td colSpan={5} className="py-6 px-4 text-center text-gray-500">No results</td>
                            </tr>
                        )}
                    </tbody>
                </table>
